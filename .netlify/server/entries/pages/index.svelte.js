...
const Routes = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `
${(0, import_index_277e1cdb.v)(import_metadata_08e68bb9.M, "Metadata").$$render($$result, {}, {}, {})}
<h1 class="${"accessibility-title svelte-jtcwvv"}">Eyebeam Home</h1>
<div class="${"homepage-menu svelte-jtcwvv"}"><section role="${"menu"}" class="${"svelte-jtcwvv"}"><div class="${"column one svelte-jtcwvv"}">${(0, import_index_277e1cdb.v)(import_menu_9f832952.M, "Menu").$$render($$result, {}, {}, {})}</div>
...
<div class="${"header-container svelte-jtcwvv"}"><h2 class="${"svelte-jtcwvv"}"><a class="${"sub-tile header svelte-jtcwvv"}" href="${"/people"}">FEATURED ARTISTS</a></h2></div>
	...
	${(0, import_get.default)(stickers, "stickerRight.enabled", false) ? `<div class="${"socials middle svelte-jtcwvv"}"><ul class="${"svelte-jtcwvv"}"><li class="${"svelte-jtcwvv"}"><a href="${"/newsletter"}" class="${"tile social newsletter svelte-jtcwvv"}" sveltekit:prefetch><div class="${"icon svelte-jtcwvv"}">${(0, import_index_277e1cdb.v)(import_menu_9f832952.N, "Newsletter").$$render($$result, {}, {}, {})}</div></a></li>
	<li class="${"svelte-jtcwvv"}"><a${(0, import_index_277e1cdb.a)("href", import_global_eadaa9b6.I, 0)} target="${"_blank"}" class="${"tile social instagram svelte-jtcwvv"}"><div class="${"icon svelte-jtcwvv"}">${(0, import_index_277e1cdb.v)(import_menu_9f832952.I, "Instagram").$$render($$result, {}, {}, {})}</div></a></li>
	<li class="${"svelte-jtcwvv"}"><a${(0, import_index_277e1cdb.a)("href", import_global_eadaa9b6.T, 0)} target="${"_blank"}" class="${"tile social twitter svelte-jtcwvv"}"><div class="${"icon svelte-jtcwvv"}">${(0, import_index_277e1cdb.v)(import_menu_9f832952.T, "Twitter").$$render($$result, {}, {}, {})}</div></a></li>
	<li class="${"svelte-jtcwvv"}"><a${(0, import_index_277e1cdb.a)("href", import_global_eadaa9b6.Y, 0)} target="${"_blank"}" class="${"tile social youtube svelte-jtcwvv"}"><div class="${"icon svelte-jtcwvv"}">${(0, import_index_277e1cdb.v)(import_menu_9f832952.Y, "Youtube").$$render($$result, {}, {}, {})}</div></a></li></ul></div>` : ``}
...
<div class="${"title svelte-jtcwvv"}"><h3 class="${"svelte-jtcwvv"}">${(0, import_index_277e1cdb.e)((0, import_truncate.default)(post.title, { length: 72 }))}</h3></div>
					${post.people && post.people.length > 0 ? `<div class="${"event-people"}">${post.people.length <= 1 ? `${(0, import_index_277e1cdb.v)(import_person_link_list_66a83380.P, "PersonLinkList").$$render($$result, {
      people: post.people,
      tiny: (0, import_get.default)(stickers, "stickerRight.enabled", false)
    }, {}, {})}` : `${(0, import_index_277e1cdb.v)(import_person_link_list_66a83380.P, "PersonLinkList").$$render($$result, {
...
<li class="${"svelte-jtcwvv"}"><a${(0, import_index_277e1cdb.a)("href", import_global_eadaa9b6.I, 0)} target="${"_blank"}" class="${"tile social instagram svelte-jtcwvv"}"><div class="${"icon svelte-jtcwvv"}">${(0, import_index_277e1cdb.v)(import_menu_9f832952.I, "Instagram").$$render($$result, {}, {}, {})}</div></a></li>
<li class="${"svelte-jtcwvv"}"><a${(0, import_index_277e1cdb.a)("href", import_global_eadaa9b6.T, 0)} target="${"_blank"}" class="${"tile social twitter svelte-jtcwvv"}"><div class="${"icon svelte-jtcwvv"}">${(0, import_index_277e1cdb.v)(import_menu_9f832952.T, "Twitter").$$render($$result, {}, {}, {})}</div></a></li>
<li class="${"svelte-jtcwvv"}"><a${(0, import_index_277e1cdb.a)("href", import_global_eadaa9b6.Y, 0)} target="${"_blank"}" class="${"tile social youtube svelte-jtcwvv"}"><div class="${"icon svelte-jtcwvv"}">${(0, import_index_277e1cdb.v)(import_menu_9f832952.Y, "Youtube").$$render($$result, {}, {}, {})}</div></a></li></ul></div>` : ``}</div></section></section></div>
