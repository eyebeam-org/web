...
const _error = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"main-content svelte-b7u5nb"}"><div class="${"article svelte-b7u5nb"}"><h1 class="${"svelte-b7u5nb"}">${(0, import_index_68ac15fd.e)((0, import_get.default)($pageStore, "error.name", ""))}</h1>
		<div class="${"description svelte-b7u5nb"}">${(0, import_index_68ac15fd.e)((0, import_get.default)($pageStore, "error.message", ""))}</div>
	...
	${(0, import_index_68ac15fd.v)(import_bottom_bar_9ab2e699.B, "BottomBar").$$render($$result, {}, {}, {})}</div>
