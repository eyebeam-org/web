...
const Everything = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.preprocess === void 0 && $$bindings.preprocess && preprocess !== void 0)
...
<div class="${"main-content svelte-ne7u20"}"><div class="${"inner svelte-ne7u20"}"><header class="${"header svelte-ne7u20"}"><h1 class="${"svelte-ne7u20"}">${(0, import_index_277e1cdb.e)(page.title)}</h1>
			
			${(0, import_has.default)(page, "content.content") ? `<div class="${"description svelte-ne7u20"}">${(0, import_index_277e1cdb.v)(import_blocks_4014f298.B, "Blocks").$$render($$result, { blocks: page.content.content }, {}, {})}</div>` : ``}
