...
<div class="${"main-content svelte-bj8d6r"}"><div class="${"inner svelte-bj8d6r"}">
		<h1 class="${"svelte-bj8d6r"}">${(0, import_index_277e1cdb.e)(page.title)}</h1>

		
		${(0, import_has.default)(page, "content.content") ? `<div class="${"body-content svelte-bj8d6r"}">${(0, import_index_277e1cdb.v)(import_blocks_57d28cdb.B, "Blocks").$$render($$result, { blocks: page.content.content }, {}, {})}</div>` : ``}
		...
		<form action="${"https://eyebeam.us4.list-manage.com/subscribe?u=c72c271895f3f76b36105229c"}" method="${"get"}" id="${"subscribe"}" class="${" svelte-bj8d6r"}"><input type="${"hidden"}" name="${"u"}" value="${"c72c271895f3f76b36105229c"}" class="${"svelte-bj8d6r"}">
			...
			<input type="${"email"}" name="${"MERGE0"}" class="${"email svelte-bj8d6r"}"${(0, import_index_277e1cdb.a)("value", emailAddress, 0)}>
