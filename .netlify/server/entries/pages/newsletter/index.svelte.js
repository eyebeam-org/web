...
<div class="${"main-content svelte-bj8d6r"}"><div class="${"inner svelte-bj8d6r"}">
		...
		${(0, import_has.default)(page, "content.content") ? `<div class="${"body-content svelte-bj8d6r"}">${(0, import_index_68ac15fd.v)(import_blocks_7e60b135.B, "Blocks").$$render($$result, { blocks: page.content.content }, {}, {})}</div>` : ``}
