...
const get = async (request) => {
  const news = await (0, import_sanity_bf41d9e1.l)("*[_type == 'news']");
  const press = await (0, import_sanity_bf41d9e1.l)("*[_type == 'press']");
  const page = await (0, import_sanity_bf41d9e1.l)("*[_id == 'press-and-news']{..., internalLinks[]->{...}}[0]");
  return {
    body: {
