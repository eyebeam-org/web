...
const Twitter = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
...
const Instagram = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
...
const Youtube = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
...
const Large_search = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
...
const Menu = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
...
<a class="${"menu-button svelte-hfkits"}" href="${"#search"}"><span class="${"search-text"}">Search</span> <span class="${"icon svelte-hfkits"}">${(0, import_index_277e1cdb.v)(Large_search, "SearchIcon").$$render($$result, {}, {}, {})}</span></a></div></nav>
