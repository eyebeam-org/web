...
const See_also = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="${"see-also svelte-rp6j0l"}"><div class="${"header"}">Read more:</div>
    ...
    return `<li><a${(0, import_index_277e1cdb.a)("href", link.linkUrl, 0)} target="${"_blank"}" class="${"svelte-rp6j0l"}">${(0, import_index_277e1cdb.e)(link.linkText)} ${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.E, "ExternalLink").$$render($$result, {}, {}, {})}</a>
				</li>`;
  })}` : ``}</ul>
</div>`;
});
