...
const Press_and_news_item = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.post === void 0 && $$bindings.post && post !== void 0)
    $$bindings.post(post);
  $$result.css.add(css);
  return `<a${(0, import_index_277e1cdb.a)("href", "/press-and-news/" + post.slug.current, 0)} class="${"press-and-news-item " + (0, import_index_277e1cdb.e)(post._type) + " svelte-y167d9"}" sveltekit:prefetch><div class="${"date svelte-y167d9"}">${(0, import_index_277e1cdb.e)((0, import_global_61b718ff.s)(post._createdAt))}</div>
	<div class="${"title svelte-y167d9"}">${(0, import_index_277e1cdb.e)(post.title)}</div>
	${post.source ? `<div class="${"source svelte-y167d9"}">${(0, import_index_277e1cdb.e)(post.source)}</div>` : ``}
</a>`;
});
