...
var import_see_also_0890c1bb = require("./see-also-0890c1bb.js");
...
<div class="${"video-block svelte-q3dcfc"}"><div class="${"embed svelte-q3dcfc"}">${`
			...
			<div class="${"icon svelte-q3dcfc"}">${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.P, "PlayArrow").$$render($$result, {}, {}, {})}</div>
...
const Main_content = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"main-content svelte-1xdc4al"}" tabindex="${"0"}"><article class="${"article svelte-1xdc4al"}">${page._type == "videoPost" ? `${(0, import_index_277e1cdb.v)(Video_player, "VideoPlayer").$$render($$result, { page }, {}, {})}` : `<header class="${[
    ...
    return `${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.a, "PersonLink").$$render($$result, { person }, {}, {})}`;
			...
			${page.externalLink ? `<a${(0, import_index_277e1cdb.a)("href", page.externalLink, 0)} class="${"button read-original svelte-1xdc4al"}" target="${"_blank"}">Read original article on ${(0, import_index_277e1cdb.e)(page.source)} ${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.E, "ExternalLink").$$render($$result, {}, {}, {})}</a>` : ``}` : ``}

					
					${showIntroduction && (0, import_has.default)(page, "introduction.content", []) ? `<div>${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.B, "Blocks").$$render($$result, { blocks: page.introduction.content }, {}, {})}</div>` : ``}</div>
				...
				${(0, import_has.default)(page, "mainImage.asset") ? `<figure class="${"image-container svelte-1xdc4al"}"><img class="${"main-image svelte-1xdc4al"}"${(0, import_index_277e1cdb.a)("alt", page.mainImage.alt, 0)}${(0, import_index_277e1cdb.a)("src", (0, import_sanity_bfd50d1d.u)(page.mainImage).quality(90).saturation(-100).width(400).url(), 0)}>
						${(0, import_has.default)(page, "mainImage.caption.content") ? `<figcaption>${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.B, "Blocks").$$render($$result, { blocks: page.mainImage.caption.content }, {}, {})}</figcaption>` : ``}</figure>` : ``}</header>`}

		
		${page._type === "event" && ((0, import_has.default)(page, "location.content") || (0, import_has.default)(page, "startDate")) ? `<div class="${"event-info svelte-1xdc4al"}">${page.startDate ? `<div class="${"dates svelte-1xdc4al"}"><h3>Dates</h3>
				...
				${(0, import_has.default)(page, "location.content") ? `<div class="${"location"}"><h3>Location</h3>
						${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.B, "Blocks").$$render($$result, { blocks: page.location.content }, {}, {})}</div>` : ``}</div>` : ``}
    ...
    return `${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.a, "PersonLink").$$render($$result, { person }, {}, {})}`;
		...
		${page.website ? `<div class="${"website svelte-1xdc4al"}" id="${"website"}"><h3>Website</h3>
				<p><a${(0, import_index_277e1cdb.a)("href", page.website, 0)} target="${"_blank"}">${(0, import_index_277e1cdb.e)(page.website)} ${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.E, "ExternalLink").$$render($$result, {}, {}, {})}</a></p></div>` : ``}

		
		${(0, import_has.default)(page, "bio.content") ? `<div class="${"bio svelte-1xdc4al"}" id="${"bio"}"><h3>Bio</h3>
				${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.B, "Blocks").$$render($$result, { blocks: page.bio.content }, {}, {})}</div>` : ``}

		
		${(0, import_has.default)(page, "content.content") ? `${(0, import_index_277e1cdb.v)(import_blocks_9c29c100.B, "Blocks").$$render($$result, { blocks: page.content.content }, {}, {})}` : ``}
