...
const External_link = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
...
const Process_text_mark = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { defs = {} } = $$props;
  let { c = {} } = $$props;
...
const Text_mark = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { defs = {} } = $$props;
  let { c = {} } = $$props;
...
const Text = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  console.log("b: ", b);
  ...
  return `${b.children && b.children.length > 0 ? `${b.style == "h2" ? `<h2${(0, import_index_68ac15fd.a)("id", slug, 0)} class="${"svelte-qdbjhv"}">${(0, import_index_68ac15fd.h)(b.children, (c) => {
    return `${!c.marks || c.marks.length === 0 ? `${(0, import_index_68ac15fd.e)(c.text)}` : `<strong>${(0, import_index_68ac15fd.e)(c.text)}</strong>`}`;
  })}</h2>` : `${b.style == "h3" ? `<h3 class="${"svelte-qdbjhv"}">${(0, import_index_68ac15fd.h)(b.children, (c) => {
    return `${(0, import_index_68ac15fd.e)(c.text)}`;
  })}</h3>` : `<p>${(0, import_index_68ac15fd.h)(b.children, (c) => {
    return `${(0, import_index_68ac15fd.v)(Text_mark, "TextMark").$$render($$result, { c, defs: b.markDefs }, {}, {})}`;
  })}</p>`}`}` : ``}`;
});
const css$e = {
...
const Html = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$e);
  return `${b.children && b.children.length > 0 ? `<div class="${"html-content svelte-102ncnr"}">${(0, import_index_68ac15fd.h)(b.children, (c) => {
...
const Image = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
...
const InvertedBlock = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$c);
  return `<div class="${"inverted-block svelte-11ng4xn"}">${(0, import_index_68ac15fd.v)(Text, "Text").$$render($$result, { b }, {}, {})}
</div>`;
});
const css$b = {
...
const Block_beam = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
...
const LogoBlock = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$a);
  return `<div class="${"logo-block svelte-1gwfimh"}"><div class="${"top-row svelte-1gwfimh"}"><div class="${"beam svelte-1gwfimh"}">${(0, import_index_68ac15fd.v)(Block_beam, "BlockBeam").$$render($$result, {}, {}, {})}</div>
		<div class="${"line svelte-1gwfimh"}"></div></div>
	<div class="${"logoblock-text svelte-1gwfimh"}">${(0, import_index_68ac15fd.v)(Text, "Text").$$render($$result, { b }, {}, {})}</div>
</div>`;
});
const css$9 = {
...
const Embed = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$9);
  return `<div class="${"embed svelte-23luwt"}"><div class="${"inner svelte-23luwt"}">${b.url.includes("youtube") ? `<iframe width="${"720"}" height="${"480"}" src="${"https://www.youtube.com/embed/" + (0, import_index_68ac15fd.e)((0, import_get_video_id.default)(b.url).id)}" frameborder="${"0"}" allow="${"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen class="${"svelte-23luwt"}"></iframe>` : ``}
		${b.url.includes("vimeo") ? `<iframe width="${"720"}" height="${"480"}" src="${"https://player.vimeo.com/video/" + (0, import_index_68ac15fd.e)((0, import_get_video_id.default)(b.url).id)}" frameborder="${"0"}" color="${"#ffffff"}" allow="${"autoplay; fullscreen"}" allowfullscreen class="${"svelte-23luwt"}"></iframe>` : ``}</div></div>

${(0, import_has.default)(b, "caption.content") ? `<figcaption>${(0, import_index_68ac15fd.v)(Blocks, "Blocks").$$render($$result, { blocks: b.caption.content }, {}, {})}</figcaption>` : ``}`;
});
const css$8 = {
...
const Divider = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
...
const Columns = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  ...
  return `<div class="${"columns svelte-1u8tfze"}">${b.title ? `<h2${(0, import_index_68ac15fd.a)("id", slug, 0)} class="${"svelte-1u8tfze"}">${(0, import_index_68ac15fd.e)(b.title)}</h2>` : ``}
	${(0, import_has.default)(b, "columnContent.content") ? `<div class="${"inner svelte-1u8tfze"}">${(0, import_index_68ac15fd.v)(Blocks, "Blocks").$$render($$result, { blocks: b.columnContent.content }, {}, {})}</div>` : ``}
</div>`;
});
const css$6 = {
...
const DonationWidget = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
...
const ApplicationButton = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
	...
	<div class="${"application-button-large svelte-1hagszj"}"><div class="${"column first svelte-1hagszj"}">
			<div class="${"top svelte-1hagszj"}"><div class="${"col first"}"><div class="${"circle svelte-1hagszj"}"></div></div>
				<div class="${"col second svelte-1hagszj"}"><div class="${"headline svelte-1hagszj"}">APPLICATIONS ARE OPEN</div>
					${b.applicationEndDate ? `<div class="${"date svelte-1hagszj"}">Due by ${(0, import_index_68ac15fd.e)((0, import_global_61b718ff.l)(b.applicationEndDate))}</div>` : ``}</div></div>

			
			${(0, import_has.default)(b, "longText.content") ? `<div class="${"text svelte-1hagszj"}">${(0, import_index_68ac15fd.v)(Blocks, "Blocks").$$render($$result, { blocks: b.longText.content }, {}, {})}</div>` : ``}</div>

		<div class="${"column second svelte-1hagszj"}">
			<a${(0, import_index_68ac15fd.a)("href", b.url, 0)} target="${"_blank"}" class="${"apply-now svelte-1hagszj"}">${(0, import_index_68ac15fd.e)(b.shortText)}</a></div></div>` : `
	<div class="${"application-button-small svelte-1hagszj"}"><div class="${"application-button-inner svelte-1hagszj"}"><a${(0, import_index_68ac15fd.a)("href", b.url, 0)} target="${"_blank"}" class="${"button svelte-1hagszj"}">${b.applicationEndDate ? `<div class="${"circle svelte-1hagszj"}"></div>` : ``}
				<div class="${"applications-text svelte-1hagszj"}"><div class="${"short-text"}">${(0, import_index_68ac15fd.e)(b.shortText)}</div>
					${b.applicationEndDate ? `<div class="${"date svelte-1hagszj"}">Applications Due by ${(0, import_index_68ac15fd.e)((0, import_global_61b718ff.l)(b.applicationEndDate))}</div>` : ``}</div></a></div></div>`}`;
});
const css$4 = {
  code: "svg.svelte-1g6edcb path.svelte-1g6edcb{fill:var(--foreground-color)}",
  map: null
};
const Arrow_left = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
...
const QuestionAnswerItem = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { item = {} } = $$props;
  if ($$props.item === void 0 && $$bindings.item && item !== void 0)
    $$bindings.item(item);
  $$result.css.add(css$3);
  return `<div class="${"qa svelte-u3h2d3"}"><div class="${"question svelte-u3h2d3"}"><div class="${"text svelte-u3h2d3"}">${(0, import_index_68ac15fd.e)(item.question)}</div>
		<div class="${"icon svelte-u3h2d3"}">${`${(0, import_index_68ac15fd.v)(Arrow_left, "ArrowLeft").$$render($$result, {}, {}, {})}`}</div></div>
	${``}
</div>`;
});
const css$2 = {
...
const Faq = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  let slug = (0, import_slugify.default)(b.title, { lower: true });
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
  $$result.css.add(css$2);
  return `<div class="${"faq svelte-13wm55"}"><h2${(0, import_index_68ac15fd.a)("id", slug, 0)} class="${"svelte-13wm55"}">${(0, import_index_68ac15fd.e)(b.title)}</h2>
	<div class="${"faq-inner svelte-13wm55"}">${(0, import_index_68ac15fd.h)(b.questionAnswer, (item) => {
    return `${(0, import_index_68ac15fd.v)(QuestionAnswerItem, "QA").$$render($$result, { item }, {}, {})}`;
  })}</div>
</div>`;
});
const css$1 = {
...
const Play_arrow = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
...
const PersonList = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { b = {} } = $$props;
  if ($$props.b === void 0 && $$bindings.b && b !== void 0)
    $$bindings.b(b);
...
const Blocks = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { blocks = [] } = $$props;
  ...
  return `${(0, import_index_68ac15fd.h)(blocks, (b) => {
    return `${b._type == "block" ? `${b.style == "logoBlock" ? `${(0, import_index_68ac15fd.v)(LogoBlock, "LogoBlock").$$render($$result, { b }, {}, {})}` : `${b.style == "invertedBlock" ? `${(0, import_index_68ac15fd.v)(InvertedBlock, "InvertedBlock").$$render($$result, { b }, {}, {})}` : `${b.style == "html" ? `${(0, import_index_68ac15fd.v)(Html, "HTML").$$render($$result, { b }, {}, {})}` : `${(0, import_index_68ac15fd.v)(Text, "Text").$$render($$result, { b }, {}, {})}`}`}`}` : ``}
	${b._type == "image" ? `${(0, import_index_68ac15fd.v)(Image, "Image").$$render($$result, { b }, {}, {})}` : ``}
	${b._type == "embedBlock" ? `${(0, import_index_68ac15fd.v)(Embed, "Embed").$$render($$result, { b }, {}, {})}` : ``}
	${b._type == "dividerBlock" ? `${(0, import_index_68ac15fd.v)(Divider, "Divider").$$render($$result, { b }, {}, {})}` : ``}
	${b._type == "columnsBlock" ? `${(0, import_index_68ac15fd.v)(Columns, "Columns").$$render($$result, { b }, {}, {})}` : ``}
	${b._type == "donationWidget" ? `${(0, import_index_68ac15fd.v)(DonationWidget, "DonationWidget").$$render($$result, { b }, {}, {})}` : ``}
	${b._type == "applicationButton" ? `${(0, import_index_68ac15fd.v)(ApplicationButton, "ApplicationButton").$$render($$result, { b }, {}, {})}` : ``}
	${b._type == "faq" ? `${(0, import_index_68ac15fd.v)(Faq, "Faq").$$render($$result, { b }, {}, {})}` : ``}
	${b._type == "videoBlock" ? `${(0, import_index_68ac15fd.v)(Video, "Video").$$render($$result, { b }, {}, {})}` : ``}
	${b._type == "personList" ? `${(0, import_index_68ac15fd.v)(PersonList, "PersonList").$$render($$result, { b }, {}, {})}` : ``}`;
  })}`;
});
