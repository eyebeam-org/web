...
const See_also = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"see-also svelte-rp6j0l"}"><div class="${"header"}">See also:</div>
    ...
    return `<li><a${(0, import_index_277e1cdb.a)("href", "/" + import_global_61b718ff.a[link._type] + "/" + (0, import_get.default)(link, "slug.current", ""), 0)} sveltekit:prefetch class="${"svelte-rp6j0l"}">${(0, import_index_277e1cdb.e)(link.title)}</a>
				</li>`;
  })}` : ``}
		
		${externalLinks ? `${(0, import_index_277e1cdb.d)(externalLinks, (link) => {
    return `<li><a${(0, import_index_277e1cdb.a)("href", link.linkUrl, 0)} target="${"_blank"}" class="${"svelte-rp6j0l"}">${(0, import_index_277e1cdb.e)(link.linkText)} ${(0, import_index_277e1cdb.v)(import_blocks_57d28cdb.E, "ExternalLink").$$render($$result, {}, {}, {})}</a>
				</li>`;
  })}` : ``}</ul>
</div>`;
});
