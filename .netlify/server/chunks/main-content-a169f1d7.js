...
var import_blocks_57d28cdb = require("./blocks-57d28cdb.js");
var import_see_also_9d92a075 = require("./see-also-9d92a075.js");
var import_bottom_bar_2d2f7e63 = require("./bottom-bar-2d2f7e63.js");
...
<div class="${"video-block svelte-k3zfg3"}"><div class="${"embed svelte-k3zfg3"}">${`
			${page.mainImage ? `<img${(0, import_index_277e1cdb.a)("alt", page.title, 0)}${(0, import_index_277e1cdb.a)("src", (0, import_sanity_59332496.u)(page.mainImage).quality(90).saturation(-100).width(400).url(), 0)} class="${"svelte-k3zfg3"}">` : ``}
			<div class="${"icon svelte-k3zfg3"}">${(0, import_index_277e1cdb.v)(import_blocks_57d28cdb.P, "PlayArrow").$$render($$result, {}, {}, {})}</div>
			<div class="${"title svelte-k3zfg3"}">${(0, import_index_277e1cdb.e)(page.title)}
...
<div class="${"at-eyebeam svelte-sa2s07"}" id="${"at-eyebeam"}"><h2 class="${"svelte-sa2s07"}">At Eyebeam</h2>
    ...
    return `<a class="${"connected-post svelte-sa2s07"}"${(0, import_index_277e1cdb.a)("href", "/" + import_global_61b718ff.a[post._type] + "/" + post.slug.current, 0)} sveltekit:prefetch><div class="${"image svelte-sa2s07"}">${post.mainImage ? `<img${(0, import_index_277e1cdb.a)("alt", post.title, 0)} aria-describedby="${"desc"}"${(0, import_index_277e1cdb.a)("src", (0, import_sanity_59332496.u)(post.mainImage).quality(90).saturation(-100).width(400).url(), 0)} class="${"svelte-sa2s07"}">` : `<div class="${"big-title svelte-sa2s07"}">${(0, import_index_277e1cdb.e)(post.title)}</div>`}</div>
			<div class="${"text svelte-sa2s07"}"><span class="${"type svelte-sa2s07"}">${(0, import_index_277e1cdb.e)(import_global_61b718ff.b[post._type])}</span>
				<span class="${"title"}">${(0, import_index_277e1cdb.e)(post.title)}</span>
			</div></a>

				${post.mainImage ? `<span id="${"desc"}" class="${"svelte-sa2s07"}">${(0, import_index_277e1cdb.e)(post.mainImage.alt)}</span>` : ``}`;
  })}
</div>`;
});
...
const Main_content = (0, import_index_277e1cdb.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.page === void 0 && $$bindings.page && page !== void 0)
    $$bindings.page(page);
  $$result.css.add(css);
  return `<div class="${"main-content svelte-lix96d"}" tabindex="${"0"}"><article class="${"article svelte-lix96d"}">${page._type == "videoPost" ? `${(0, import_index_277e1cdb.v)(Video_player, "VideoPlayer").$$render($$result, { page }, {}, {})}` : `<header class="${[
    "header svelte-lix96d",
    (boxed ? "boxed" : "") + " " + (tight ? "tight" : "")
  ].join(" ").trim()}"><div>
					<h1 class="${["svelte-lix96d", page.title.length > 42 ? "long" : ""].join(" ").trim()}">${(0, import_index_277e1cdb.e)(page.title)}</h1>

					
					${page._type == "person" ? `<div class="${"badges svelte-lix96d"}">${page.role ? `<a${(0, import_index_277e1cdb.a)("href", "/people?filter=" + page.role, 0)} class="${"badge svelte-lix96d"}">${(0, import_index_277e1cdb.e)(import_global_61b718ff.r[page.role])}</a>` : ``}
							${page.groupTags ? `${(0, import_index_277e1cdb.d)(page.groupTags, (tag) => {
    return `<a href="${"/people"}" class="${"badge svelte-lix96d"}">${(0, import_index_277e1cdb.e)(tag.label)}</a>`;
  })}` : ``}</div>` : ``}

					
					${page.quote ? `<div class="${"quote svelte-lix96d"}">&quot;${(0, import_index_277e1cdb.e)(page.quote)}&quot;</div>` : ``}

					${page._type == "note" ? `
						<div class="${"date svelte-lix96d"}">${(0, import_index_277e1cdb.e)((0, import_global_61b718ff.e)(page._createdAt))}</div>
						
						${page.people && page.people.length > 0 ? `<div class="${"authors svelte-lix96d"}">by ${(0, import_index_277e1cdb.d)(page.people, (person) => {
    return `${(0, import_index_277e1cdb.v)(import_person_link_7a5675bf.P, "PersonLink").$$render($$result, { person }, {}, {})}`;
  })}</div>` : ``}` : ``}
				${page._type == "press" || page._type == "news" ? `${page.source ? `<div class="${"published-by svelte-lix96d"}">Published by ${(0, import_index_277e1cdb.e)(page.source)}</div>
						<div class="${"date svelte-lix96d"}">${(0, import_index_277e1cdb.e)((0, import_global_61b718ff.l)(page._createdAt))}</div>` : ``}
						
						${page.author ? `<div class="${"author svelte-lix96d"}">${(0, import_index_277e1cdb.e)(page.author)}</div>` : ``}
			${page.externalLink ? `<a${(0, import_index_277e1cdb.a)("href", page.externalLink, 0)} class="${"button read-original svelte-lix96d"}" target="${"_blank"}">Read original article on ${(0, import_index_277e1cdb.e)(page.source)} ${(0, import_index_277e1cdb.v)(import_blocks_57d28cdb.E, "ExternalLink").$$render($$result, {}, {}, {})}</a>` : ``}` : ``}

					
					${showIntroduction && (0, import_has.default)(page, "introduction.content", []) ? `<div>${(0, import_index_277e1cdb.v)(import_blocks_57d28cdb.B, "Blocks").$$render($$result, { blocks: page.introduction.content }, {}, {})}</div>` : ``}</div>

				
				${(0, import_has.default)(page, "mainImage.asset") ? `<figure class="${"image-container svelte-lix96d"}"><img class="${"main-image svelte-lix96d"}"${(0, import_index_277e1cdb.a)("alt", page.mainImage.alt, 0)}${(0, import_index_277e1cdb.a)("src", (0, import_sanity_59332496.u)(page.mainImage).quality(90).saturation(-100).width(400).url(), 0)}>
						${(0, import_has.default)(page, "mainImage.caption.content") ? `<figcaption>${(0, import_index_277e1cdb.v)(import_blocks_57d28cdb.B, "Blocks").$$render($$result, { blocks: page.mainImage.caption.content }, {}, {})}</figcaption>` : ``}</figure>` : ``}</header>`}

		
		${page._type === "event" ? `<div class="${"event-info svelte-lix96d"}">${page.startDate ? `<div class="${"dates svelte-lix96d"}"><h3>Dates</h3>
						${(0, import_index_277e1cdb.e)((0, import_global_61b718ff.l)(page.startDate))}</div>` : ``}
				${(0, import_has.default)(page, "location.content") ? `<div class="${"location"}"><h3>Location</h3>
						${(0, import_index_277e1cdb.v)(import_blocks_57d28cdb.B, "Blocks").$$render($$result, { blocks: page.location.content }, {}, {})}</div>` : ``}</div>` : ``}
    ...
    return `${(0, import_index_277e1cdb.v)(import_person_link_7a5675bf.P, "PersonLink").$$render($$result, { person }, {}, {})}`;
		...
		${page.website ? `<div class="${"website svelte-lix96d"}" id="${"website"}"><h3>Website</h3>
				<p><a${(0, import_index_277e1cdb.a)("href", page.website, 0)} target="${"_blank"}">${(0, import_index_277e1cdb.e)(page.website)} ${(0, import_index_277e1cdb.v)(import_blocks_57d28cdb.E, "ExternalLink").$$render($$result, {}, {}, {})}</a></p></div>` : ``}

		
		${(0, import_has.default)(page, "bio.content") ? `<div class="${"bio svelte-lix96d"}" id="${"bio"}"><h3>Bio</h3>
				${(0, import_index_277e1cdb.v)(import_blocks_57d28cdb.B, "Blocks").$$render($$result, { blocks: page.bio.content }, {}, {})}</div>` : ``}

		
		${(0, import_has.default)(page, "content.content") ? `${(0, import_index_277e1cdb.v)(import_blocks_57d28cdb.B, "Blocks").$$render($$result, { blocks: page.content.content }, {}, {})}` : ``}
		...
		${page.transcript && page.transcript.asset && page.transcript.asset._ref ? `<div class="${"transcript svelte-lix96d"}" id="${"transcript"}"><h2>Transcript</h2>
				<a${(0, import_index_277e1cdb.a)("href", page.transcriptUrl, 0)} target="${"_blank"}" class="${"transcript-button svelte-lix96d"}">Download transcript as .PDF
				</a></div>` : ``}
		...
		${showPeople && (0, import_get.default)(page, "people", []).length > 0 ? `<div class="${"people svelte-lix96d"}" id="${"people"}"><h2 class="${"svelte-lix96d"}">People</h2>
				<div class="${"people-inner svelte-lix96d"}">${(0, import_index_277e1cdb.d)(page.people, (person) => {
    return `<a class="${"people-link svelte-lix96d"}"${(0, import_index_277e1cdb.a)("href", "/people/" + person.slug.current, 0)} sveltekit:prefetch><div class="${"image svelte-lix96d"}">${person.mainImage ? `<img${(0, import_index_277e1cdb.a)("alt", person.title, 0)}${(0, import_index_277e1cdb.a)("src", (0, import_sanity_59332496.u)(person.mainImage).quality(90).width(400).url(), 0)} class="${"svelte-lix96d"}">` : ``}</div>
							<div class="${"text"}"><span class="${"title svelte-lix96d"}">${(0, import_index_277e1cdb.e)(person.title)}</span></div>
						</a>`;
  })}</div></div>` : ``}
		...
		${page.internalLinks || page.externalLinks ? `${(0, import_index_277e1cdb.v)(import_see_also_9d92a075.S, "SeeAlso").$$render($$result, {
    externalLinks: page.externalLinks,
    internalLinks: page.internalLinks
  }, {}, {})}` : ``}</article>

	
	${(0, import_index_277e1cdb.v)(import_bottom_bar_2d2f7e63.B, "BottomBar").$$render($$result, { updatedAt: page._updatedAt }, {}, {})}
</div>`;
});
