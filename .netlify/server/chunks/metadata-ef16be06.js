...
const Metadata = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `${$$result.title = `<title>${(0, import_index_68ac15fd.e)(title)}</title>`, ""}<meta name="${"twitter:card"}" content="${"summary_large_image"}" data-svelte="svelte-1uy2fdk"><meta name="${"twitter:url"}"${(0, import_index_68ac15fd.a)("content", url, 0)} data-svelte="svelte-1uy2fdk"><meta property="${"og:url"}"${(0, import_index_68ac15fd.a)("content", url, 0)} data-svelte="svelte-1uy2fdk"><meta property="${"og:type"}" content="${"article"}" data-svelte="svelte-1uy2fdk"><meta property="${"twitter:title"}"${(0, import_index_68ac15fd.a)("content", title, 0)} data-svelte="svelte-1uy2fdk"><meta property="${"twitter:description"}"${(0, import_index_68ac15fd.a)("content", description, 0)} data-svelte="svelte-1uy2fdk"><meta property="${"og:title"}"${(0, import_index_68ac15fd.a)("content", title, 0)} data-svelte="svelte-1uy2fdk"><meta property="${"description"}"${(0, import_index_68ac15fd.a)("content", description, 0)} data-svelte="svelte-1uy2fdk"><meta property="${"og:description"}"${(0, import_index_68ac15fd.a)("content", description, 0)} data-svelte="svelte-1uy2fdk"><meta property="${"image"}"${(0, import_index_68ac15fd.a)("content", image, 0)} data-svelte="svelte-1uy2fdk"><meta property="${"og:image"}"${(0, import_index_68ac15fd.a)("content", image, 0)} data-svelte="svelte-1uy2fdk"><meta property="${"twitter:image"}"${(0, import_index_68ac15fd.a)("content", image, 0)} data-svelte="svelte-1uy2fdk"><meta property="${"og:site_name"}" content="${"Platform Labor"}" data-svelte="svelte-1uy2fdk">`, ""}`;
});
