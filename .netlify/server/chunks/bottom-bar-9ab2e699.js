...
const Half_beam = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
...
const Arrow_up = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
...
const Bottom_bar = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  let { updatedAt = false } = $$props;
  if ($$props.updatedAt === void 0 && $$bindings.updatedAt && updatedAt !== void 0)
    $$bindings.updatedAt(updatedAt);
  $$result.css.add(css);
  return `<div class="${"bottom-bar svelte-h78hb5"}">${updatedAt ? `<div class="${"last-updated svelte-h78hb5"}"><span class="${"icon svelte-h78hb5"}">${(0, import_index_68ac15fd.v)(Half_beam, "HalfBeam").$$render($$result, {}, {}, {})}</span> Last updated: ${(0, import_index_68ac15fd.e)((0, import_global_61b718ff.d)(updatedAt))}</div>` : ``}
	<a href="${"#"}" class="${"back-to-top svelte-h78hb5"}">Back to top <span class="${"icon svelte-h78hb5"}">${(0, import_index_68ac15fd.v)(Arrow_up, "ArrowUp").$$render($$result, {}, {}, {})}</span></a>
</div>`;
});
