...
const See_also = (0, import_index_68ac15fd.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"see-also svelte-rp6j0l"}"><div class="${"header"}">See also:</div>
    ...
    return `<li><a${(0, import_index_68ac15fd.a)("href", link.linkUrl, 0)} target="${"_blank"}" class="${"svelte-rp6j0l"}">${(0, import_index_68ac15fd.e)(link.linkText)} ${(0, import_index_68ac15fd.v)(import_blocks_c75ee098.E, "ExternalLink").$$render($$result, {}, {}, {})}</a>
				</li>`;
  })}` : ``}</ul>
</div>`;
});
